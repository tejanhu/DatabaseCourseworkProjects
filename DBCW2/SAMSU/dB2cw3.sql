	...
	INSERT INTO MODULE (MODNUM, MODNAME) VALUES (100, 'ADSOOF');
	SELECT * FROM MODULE;
	...
	INSERT INTO EXAM (EXAMID, MODNUM, SYID) VALUES (20, 100, 002);
	SELECT * FROM EXAM;
	...
	SELECT COUNT(STAFFNAME) FROM STAFF WHERE DEPTNAME FROM DEPT='EECS';

	SELECT COUNT(MODNUM) FROM MODULE WHERE SUBJECT='COMPSCI';	
